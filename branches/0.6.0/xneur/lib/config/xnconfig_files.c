...
static int copy_file_to_HOME(const char *dir_name, const char *file_name)
{
...
struct _list* load_list_from_file(const char *dir_name, const char *file_name)
{
...
void save_list_to_file(struct _list *list, const char *file_name)
{
