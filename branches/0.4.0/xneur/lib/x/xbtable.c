...
static struct _xbtable btable[MAX_HOTKEYS] = { {XK_Pause, XK_Break, None}, {XK_Pause, XK_Break, XK_Control_R}, {XK_Print, XK_Sys_Req, XK_Control_R}, {XK_Pause, XK_Break, XK_Shift_R} };
